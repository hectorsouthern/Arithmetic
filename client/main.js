    ...
    'viewUserClassAvg': function() {
        if (Session.get('viewUser') != "No User Selected") {
            ...
            for (var i = 0; i < classMembers.length; i++) {
                totalAvg = totalAvg + classMembers[i].averageScore
            }
...
Template.admin.events({
    ...
    'click #sortScoreAsc': function(e, t) {
        Session.set('sortByLabel', "Score <span class='glyphicon glyphicon-chevron-up'>")
        Session.set('sortBy', "ScoreAsc");
    },
    'click #sortScoreDec': function(e, t) {
        Session.set('sortByLabel', "Score <span class='glyphicon glyphicon-chevron-down'>")
        Session.set('sortBy', "ScoreDec");
    },
    'click #sortDateAsc': function(e, t) {
        Session.set('sortByLabel', "Date <span class='glyphicon glyphicon-chevron-up'>")
        Session.set('sortBy', "DateAsc");
    },
    'click #sortDateDec': function(e, t) {
        Session.set('sortByLabel', "Date <span class='glyphicon glyphicon-chevron-down'>")
        Session.set('sortBy', "DateDec");
    },
    ...
    'click .deleteUserConfirmed': function() {
...
Template.admin.rendered = function() {
    Session.set('progChartData', null);
    this.$('#deleteUser').confirmation({
        placement: 'bottom',
        btnOkClass: 'btn btn-sm btn-danger deleteUserConfirmed'
    });
}
